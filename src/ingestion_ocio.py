...
URL_TIENDA  = "https://ocio-wine.myshopify.com"   	    # URL base de la tienda
PAIS        = "Uruguay"                                 # País de la tienda
MONEDA      = "UYU"                                     # Moneda (ARS, USD, EUR, UYU)
NOMBRE_CSV  = "ocio_products.csv"                       # Nombre del archivo de salida
