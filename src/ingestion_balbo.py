...
URL_TIENDA  = "https://tienda.susanabalbowines.com.ar"  # URL base de la tienda
PAIS        = "Argentina"                                 # País de la tienda
MONEDA      = "ARS"                                     # Moneda (ARS, USD, EUR, UYU)
NOMBRE_CSV  = "balbo_products.csv"                       # Nombre del archivo de salida
